...
import com.buaa.yyg.baidupager.utils.ImageLoader;
 ...
 */
public class MyScrollViewPhone extends ScrollView implements View.OnTouchListener {
    ...
    private static Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            MyScrollViewPhone myScrollView = (MyScrollViewPhone) msg.obj;
     ...
     * @param attrs
     */
    public MyScrollViewPhone(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void loadMoreImages() {
        if (hasSDCard()) {
            ...
            if (startIndex < imageUrl.size()) {
                Toast.makeText(getContext(), "正在加载...", Toast.LENGTH_SHORT)
                        .show();
                if (endIndex > imageUrl.size()) {
                    endIndex = imageUrl.size();
                }
                for (int i = startIndex; i < endIndex; i++) {
                    LoadImageTask task = new LoadImageTask();
                    taskCollection.add(task);
                    task.execute(imageUrl.get(i));
                }
                page++;
            } else {
