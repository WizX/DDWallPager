package com.buaa.yyg.baidupager.recyclerview;
...
public class HomeRecyclerRefreshHeaderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private List<Tngou> image = new ArrayList<>();
    private Context context;
    private onItemClickListener listener;

    public HomeRecyclerRefreshHeaderAdapter(Context context) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        Glide.with(context)
                .load(TnGou.PRE_IMAGE_URL + image.get(position).getImg())
    ...
    public ArrayList<String> getAllImage(){
        ...
        for (int i = 0; i < image.size(); i++) {
            imageString.add(TnGou.PRE_IMAGE_URL + image.get(i).getImg());
        }
        return imageString;
    }
     ...
     * @param imageUrl
     */
    public void addMoreItem(List<Tngou> imageUrl, int lastVisibleItemPosition) {
...
//        notifyDataSetChanged();
     ...
     * @param imageUrl
     */
    public void addTopItem(List<Tngou> imageUrl) {
